...
> **Reference record.** The privacy and trust design written for the earlier Preview, kept unchanged for audit. Some features it describes (for example Campaign deletion manifests and diagnostic export preview) are not implemented in the current RC. Current page: [privacy and trust](../privacy.md).
